<template>
  <block class="m-4 lg:mt-8 xl:mt-12 xl:mx-auto">
    ...
    <div class="md:flex md:flex-row items-center p-6">
      ...
      <p>
        Developer @ <a href="https://www.trinax.se/" target="_blank" style="color: #0d6f99">Trinax AB</a>
      </p>
    </div>
    ...
    <div class="lg:flex lg:flex-row flex-no-wrap items-center border-t border-gray-400">
      ...
      <div class="lg:w-2/3 p-6 lg:border-r border-gray-400">
        ...
        <p>
          My main area of expertise is modern PHP and complex JavaScript frontends.
        </p>
        <p class="mt-4">
          While my best work is done in the back-end implementing and taking care of the business logic,
          I have no problems implementing a feature rich and good looking front-end.
        </p>
      </div>
